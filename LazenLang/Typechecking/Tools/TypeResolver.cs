...
namespace LazenLang.Typechecking.Tools
{
    class TypeResolver
    {
        public static TypeDesc ResolveType(NativeArray arr)
        {
        ...
        public static TypeDesc ResolveType(Instanciation instanciation)
        {
            ...
            {
                //return new TypeApp(new NameType(instanciation.ClassName), )
            }
